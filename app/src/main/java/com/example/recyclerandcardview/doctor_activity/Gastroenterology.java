...
public class Gastroenterology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Gastroenterology_name);
        DrDesc = getResources().getStringArray(R.array.Gastroenterology_desc);
        details = getResources().getStringArray(R.array.Gastroenterology_details);
        phone = getResources().getStringArray(R.array.Gastroenterology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Gastroenterology.this, Profile.class);
