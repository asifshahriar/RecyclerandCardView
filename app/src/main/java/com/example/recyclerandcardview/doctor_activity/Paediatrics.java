...
public class Paediatrics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Paediatrics_name);
        DrDesc = getResources().getStringArray(R.array.Paediatrics_desc);
        details = getResources().getStringArray(R.array.Paediatrics_details);
        phone = getResources().getStringArray(R.array.Paediatrics_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Paediatrics.this, Profile.class);
