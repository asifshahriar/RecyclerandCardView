...
public class ENT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.ENT_name);
        DrDesc = getResources().getStringArray(R.array.ENT_desc);
        details = getResources().getStringArray(R.array.ENT_details);
        phone = getResources().getStringArray(R.array.ENT_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(ENT.this, Profile.class);
