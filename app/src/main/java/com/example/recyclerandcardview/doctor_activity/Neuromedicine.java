...
public class Neuromedicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Neuromedicine_name);
        DrDesc = getResources().getStringArray(R.array.Neuromedicine_desc);
        details = getResources().getStringArray(R.array.Neuromedicine_details);
        phone = getResources().getStringArray(R.array.Neuromedicine_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Neuromedicine.this, Profile.class);
