...
public class Orthopedics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Orthopedics_name);
        DrDesc = getResources().getStringArray(R.array.Orthopedics_desc);
        details = getResources().getStringArray(R.array.Orthopedics_details);
        phone = getResources().getStringArray(R.array.Orthopedics_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Orthopedics.this, Profile.class);
