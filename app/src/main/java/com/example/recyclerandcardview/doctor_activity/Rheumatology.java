...
public class Rheumatology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Rheumatology_name);
        DrDesc = getResources().getStringArray(R.array.Rheumatology_desc);
        details = getResources().getStringArray(R.array.Rheumatology_details);
        phone = getResources().getStringArray(R.array.Rheumatology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Rheumatology.this, Profile.class);
