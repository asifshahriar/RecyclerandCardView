...
public class PaediatricSurgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Paediatric_Surgery_name);
        DrDesc = getResources().getStringArray(R.array.Paediatric_Surgery_desc);
        details = getResources().getStringArray(R.array.Paediatric_Surgery_details);
        phone = getResources().getStringArray(R.array.Paediatric_Surgery_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(PaediatricSurgery.this, Profile.class);
