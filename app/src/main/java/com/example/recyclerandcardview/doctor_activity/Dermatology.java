...
public class Dermatology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Dermatology_name);
        DrDesc = getResources().getStringArray(R.array.Dermatology_desc);
        details = getResources().getStringArray(R.array.Dermatology_details);
        phone = getResources().getStringArray(R.array.Dermatology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Dermatology.this, Profile.class);
