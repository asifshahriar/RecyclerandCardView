...
public class Cardiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Cardiology_name);
        DrDesc = getResources().getStringArray(R.array.Cardiology_desc);
        details = getResources().getStringArray(R.array.Cardiology_details);
        phone = getResources().getStringArray(R.array.Cardiology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Cardiology.this, Profile.class);
