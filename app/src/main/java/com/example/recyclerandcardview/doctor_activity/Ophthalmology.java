...
public class Ophthalmology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Ophthalmology_name);
        DrDesc = getResources().getStringArray(R.array.Ophthalmology_desc);
        details = getResources().getStringArray(R.array.Ophthalmology_details);
        phone = getResources().getStringArray(R.array.Ophthalmology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Ophthalmology.this, Profile.class);
