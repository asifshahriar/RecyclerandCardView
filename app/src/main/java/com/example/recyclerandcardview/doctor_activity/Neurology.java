...
public class Neurology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Neurology_name);
        DrDesc = getResources().getStringArray(R.array.Neurology_desc);
        details = getResources().getStringArray(R.array.Neurology_details);
        phone = getResources().getStringArray(R.array.Neurology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Neurology.this, Profile.class);
