...
public class Dietetics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Dietetics_name);
        DrDesc = getResources().getStringArray(R.array.Dietetics_desc);
        details = getResources().getStringArray(R.array.Dietetics_details);
        phone = getResources().getStringArray(R.array.Dietetics_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Dietetics.this, Profile.class);
