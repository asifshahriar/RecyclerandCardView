...
public class Physiotherapy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Physiotherapy_name);
        DrDesc = getResources().getStringArray(R.array.Physiotherapy_desc);
        details = getResources().getStringArray(R.array.Physiotherapy_details);
        phone = getResources().getStringArray(R.array.Physiotherapy_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Physiotherapy.this, Profile.class);
