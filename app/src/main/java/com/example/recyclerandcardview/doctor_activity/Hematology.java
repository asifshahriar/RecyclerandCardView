...
public class Hematology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Hematology_name);
        DrDesc = getResources().getStringArray(R.array.Hematology_desc);
        details = getResources().getStringArray(R.array.Hematology_details);
        phone = getResources().getStringArray(R.array.Hematology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Hematology.this, Profile.class);
