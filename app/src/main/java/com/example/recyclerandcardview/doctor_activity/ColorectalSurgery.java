...
public class ColorectalSurgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colorectal_surgery);

        recycler = findViewById(R.id.recyclerId);

        DrName = getResources().getStringArray(R.array.ColorectalSurgery_name);
        DrDesc = getResources().getStringArray(R.array.ColorectalSurgery_desc);
        details = getResources().getStringArray(R.array.ColorectalSurgery_details);
        phone = getResources().getStringArray(R.array.ColorectalSurgery_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(ColorectalSurgery.this, Profile.class);
