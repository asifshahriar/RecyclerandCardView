...
public class Oncology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Oncology_name);
        DrDesc = getResources().getStringArray(R.array.Oncology_desc);
        details = getResources().getStringArray(R.array.Oncology_details);
        phone = getResources().getStringArray(R.array.Oncology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Oncology.this, Profile.class);
