...
public class Endocrinology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Endocrinology_name);
        DrDesc = getResources().getStringArray(R.array.Endocrinology_desc);
        details = getResources().getStringArray(R.array.Endocrinology_details);
        phone = getResources().getStringArray(R.array.Endocrinology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Endocrinology.this, Profile.class);
