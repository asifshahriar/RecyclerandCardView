...
public class Urology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Urology_name);
        DrDesc = getResources().getStringArray(R.array.Urology_desc);
        details = getResources().getStringArray(R.array.Urology_details);
        phone = getResources().getStringArray(R.array.Urology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Urology.this, Profile.class);
