...
public class Hepatology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Hepatology_name);
        DrDesc = getResources().getStringArray(R.array.Hepatology_desc);
        details = getResources().getStringArray(R.array.Hepatology_details);
        phone = getResources().getStringArray(R.array.Hepatology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Hepatology.this, Profile.class);
