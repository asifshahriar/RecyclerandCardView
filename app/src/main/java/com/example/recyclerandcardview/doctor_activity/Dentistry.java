...
public class Dentistry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Dentistry_name);
        DrDesc = getResources().getStringArray(R.array.Dentistry_desc);
        details = getResources().getStringArray(R.array.Dentistry_details);
        phone = getResources().getStringArray(R.array.Dentistry_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Dentistry.this, Profile.class);
