...
public class UrologySurgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Urology_Surgery_name);
        DrDesc = getResources().getStringArray(R.array.Urology_Surgery_desc);
        details = getResources().getStringArray(R.array.Urology_Surgery_details);
        phone = getResources().getStringArray(R.array.Urology_Surgery_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(UrologySurgery.this, Profile.class);
