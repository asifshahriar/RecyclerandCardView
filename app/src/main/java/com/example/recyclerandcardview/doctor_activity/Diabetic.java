...
public class Diabetic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Diabetic_name);
        DrDesc = getResources().getStringArray(R.array.Diabetic_desc);
        details = getResources().getStringArray(R.array.Diabetic_details);
        phone = getResources().getStringArray(R.array.Diabetic_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Diabetic.this, Profile.class);
