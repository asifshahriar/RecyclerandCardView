...
public class Pulmonology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Pulmonology_name);
        DrDesc = getResources().getStringArray(R.array.Pulmonology_desc);
        details = getResources().getStringArray(R.array.Pulmonology_details);
        phone = getResources().getStringArray(R.array.Pulmonology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Pulmonology.this, Profile.class);
