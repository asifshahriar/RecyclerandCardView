...
public class CardiacSurgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Cardiac_Surgery_name);
        DrDesc = getResources().getStringArray(R.array.Cardiac_Surgery_desc);
        details = getResources().getStringArray(R.array.Cardiac_Surgery_details);
        phone = getResources().getStringArray(R.array.Cardiac_Surgery_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(CardiacSurgery.this, Profile.class);
