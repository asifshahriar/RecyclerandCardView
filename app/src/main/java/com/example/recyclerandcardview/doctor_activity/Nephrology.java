...
public class Nephrology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Nephrology_name);
        DrDesc = getResources().getStringArray(R.array.Nephrology_desc);
        details = getResources().getStringArray(R.array.Nephrology_details);
        phone = getResources().getStringArray(R.array.Nephrology_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Nephrology.this, Profile.class);
