...
public class ChestDiseases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.ChestDr_name);
        DrDesc = getResources().getStringArray(R.array.ChestDr_desc);
        details = getResources().getStringArray(R.array.ChestDr_details);
        phone = getResources().getStringArray(R.array.ChestDr_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(ChestDiseases.this, Profile.class);
