...
public class Psychiatric extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrName = getResources().getStringArray(R.array.Psychiatric_name);
        DrDesc = getResources().getStringArray(R.array.Psychiatric_desc);
        details = getResources().getStringArray(R.array.Psychiatric_details);
        phone = getResources().getStringArray(R.array.Psychiatric_Phone);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.ClickListener() {
            ...
            public void onItemClick(int i, View v) {
                ...
                Intent intent = new Intent(Psychiatric.this, Profile.class);
